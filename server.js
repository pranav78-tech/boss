...
<head>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    #header{background:#161b22;border-bottom:1px solid #30363d;padding:10px 16px;display:flex;align-items:center;justify-content:space-between;position:sticky;top:0;z-index:10}
    ...
    .card{background:#161b22;border:1px solid #30363d;border-radius:8px;animation:fadeIn .3s ease}
    @keyframes fadeIn{from{opacity:0;transform:translateY(6px)}to{opacity:1;transform:translateY(0)}}
    .card-header{background:#21262d;padding:8px 12px;display:flex;justify-content:space-between;border-bottom:1px solid #30363d;border-radius:8px 8px 0 0}
    .card-time{font-size:10px;color:#6e7681}
    .card-body{padding:12px 16px;white-space:pre-wrap;font-family:Consolas,'Courier New',monospace;font-size:12.5px;line-height:1.7;color:#c9d1d9;word-break:break-word}
    #empty{padding:80px 20px;text-align:center;color:#6e7681}
...
<div id="content">
  <div id="empty"><div class="icon">Waiting for responses...</div></div>
</div>
<script>
  ...
  function newCard(label){
    ...
    header.innerHTML = '<span style="font-size:11px;font-weight:600;color:#58a6ff">' + label + '</span><span class="card-time">' + now() + '</span>';
